...
describe(`TaskListNav component`, () => {
  it("renders a .TaskListNav by default", () => {
    const wrapper = shallow(<TaskListNav />);
    expect(toJson(wrapper)).toMatchSnapshot();
  });

  // enzyme doesn't yet support React.createContext
  it.skip("renders a link in ul for each goal in array", () => {
    const context = {
      tasks: [
        {
        ...
        },
        {
          ...
          goalId: "b07161a6-ffaf-11e8-8eb2-f2801f1b9fd1",
          content: "Eos\n \rlaudantium.",
        },
        {
    ...
    const ul = shallow(<TaskListNav />, context).find("ul");
